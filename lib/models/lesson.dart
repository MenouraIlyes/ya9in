...
List<Lesson> pythonDataLessons = [
  Lesson(
    ...
    videoUrl: 'https://example.com/videos/python_pandas_intro.mp4',
    duration: 18,
  ...
  Lesson(
    ...
    videoUrl: 'https://example.com/videos/python_data_cleaning.mp4',
    duration: 20,
  ...
  Lesson(
    ...
    videoUrl: 'https://example.com/videos/python_matplotlib.mp4',
    duration: 22,
  ...
  Lesson(
    ...
    videoUrl: 'https://example.com/videos/python_eda.mp4',
    duration: 25,
  ...
  Lesson(
    ...
    videoUrl: 'https://example.com/videos/python_advanced_analysis.mp4',
    duration: 30,
